...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/h3@1.12.0/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/vue-bundle-renderer@2.1.0/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/devalue@5.0.0/node_modules/devalue/index.js';
import destr from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/destr@2.0.3/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/ufo@1.5.3/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/vue@3.4.30/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/ohash@1.1.3/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/@unhead+ssr@1.9.14/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/ofetch@1.3.4/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/unenv@1.9.0/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/unstorage@1.10.2_ioredis@5.4.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/unstorage@1.10.2_ioredis@5.4.1/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/consola@3.2.3/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/unctx@2.3.1/node_modules/unctx/dist/index.mjs';
import * as vue$1 from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/vue@3.4.30/node_modules/vue/index.mjs';
import { isVNode, version, unref } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/vue@3.4.30/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/unhead@1.9.14/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/ADMIN/Documents/projects/sash/node_modules/.pnpm/@unhead+shared@1.9.14/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/ADMIN/Documents/projects/sash/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\ADMIN\\Documents\\projects\\sash","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\ADMIN\\Documents\\projects\\sash\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\ADMIN\\Documents\\projects\\sash\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\ADMIN\\Documents\\projects\\sash\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\ADMIN\\Documents\\projects\\sash\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _iOggnW5JL7 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/ADMIN/Documents/projects/sash";
...
const _zYkKMGPqfw = defineNitroPlugin(async (nitroApp) => {
...
const _lazy_lbkKha = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_lbkKha, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_lbkKha, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/ADMIN/Documents/projects/sash/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/ADMIN/Documents/projects/sash/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
